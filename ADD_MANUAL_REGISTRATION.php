<?php
/**
 * Script untuk menambahkan peserta yang sudah bayar namun datanya tidak ada di database
 * 
 * Data dari Midtrans:
 ...
 * 2. Copy-paste script ini ke Tinker
 * Atau:
 * php artisan tinker < ADD_MANUAL_REGISTRATION.php
 */
