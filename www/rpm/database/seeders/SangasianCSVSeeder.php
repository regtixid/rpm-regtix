...
class SangasianCSVSeeder extends Seeder
{
    /**
    ...
    {
        $file = database_path('seeders/data/sangasian.csv');
        ...
        $ticketType = TicketType::where('name', 'Sangasian')->first();

        if (!$ticketType) {
            throw new \Exception("Ticket type 'Sangasian' not found.");
        }
