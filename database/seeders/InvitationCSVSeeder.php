...
class InvitationCSVSeeder extends Seeder
{
    /**
    ...
    {
        $file = database_path('seeders/data/invitation.csv');
        ...
        $ticketType = TicketType::where('name', 'Invitation')->first();

        if (!$ticketType) {
            throw new \Exception("Ticket type 'Invitation' not found.");
        }
