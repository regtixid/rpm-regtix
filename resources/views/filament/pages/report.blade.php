            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                ...
                <div class="flex flex-col sm:flex-row items-stretch sm:items-end gap-3">
                    ...
                    @else
                        <button
                            disabled
                            class="inline-flex items-center justify-center px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-100 dark:bg-gray-700 text-sm font-medium text-gray-400 dark:text-gray-500 cursor-not-allowed whitespace-nowrap"
                        >
                            <x-heroicon-o-printer class="w-4 h-4 mr-2" />
                            Print
                        </button>
